...
public class MarketplaceGUI {
    ...
    /* ---- widgets ---- */
    private final JFrame  frame  = new JFrame("ISO-Marketplace");
    private final CardLayout cards = new CardLayout();
    private final JPanel  center   = new JPanel(cards);
    private final JLabel  balLbl   = new JLabel("BAL: $0.00");
    ...
    /* ==================================================================== */
    public static void main(String[] args){ new MarketplaceGUI(); }

    public MarketplaceGUI(){ SwingUtilities.invokeLater(this::buildGUI); }
    ...
    private void buildGUI(){
        ...
        itemsPanel = new ItemsPanel();     center.add(itemsPanel,"items");
        invPanel   = new InventoryPanel(); center.add(invPanel,"inventory");
        msgPanel   = new MessagesPanel();  center.add(msgPanel,"messages");
    ...
    private class StartPanel extends JPanel
            implements ActionListener, ClientConnection.LineHandler {

        private final JTextField     user  = new JTextField(10);
        private final JPasswordField pass  = new JPasswordField(10);
        private final JTextField     start = new JTextField("100",5);

        StartPanel(){
            setLayout(new GridLayout(0,1,5,5));
            setBorder(new EmptyBorder(40,200,40,200));
            ...
            reg.addActionListener(this); log.addActionListener(this);
            JPanel row = new JPanel(); row.add(reg); row.add(log); add(row);

            add(new JLabel("Starting balance (register)"));
            add(start);
        }
    ...
    private class ItemsPanel extends JPanel implements ActionListener{
        ...
        ItemsPanel(){
            ...
            south.add(buyBtn); south.add(msgBtn); south.add(listBtn);
